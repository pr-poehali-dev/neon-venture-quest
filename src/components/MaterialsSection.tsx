...
const sections = [
  {
    ...
    items: [
      ...
      { label: 'Методические рекомендации «Организация учебной проектно-исследовательской деятельности в образовательных организациях»', url: 'https://imcbg.ru/MetodKopilka/metodicheskie_rekomendacii_ir_ip.pdf' },
    ],
  },
  {
    id: 'theory',
